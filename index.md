...
<script type="text/javascript">
    ...
    const baseDataset = [ 
        ...
        { key: 17, decade: 2010, population: 12000, color: `#bd0026`, text: `Following the Christchurch earthquakes in 2010 and 2011, many "red stickered" residents used their Government and insurance pay-outs to build new homes in Rangiora subdivisions, recently developed on ex-farmland beyond the original town "belts".`, href: ``, image:``},
        { key: 18, decade: 2020, population: 23000, color: `#800026`, text: `Rangiora is still very much a rural township even after the significant population growth since 2010`, href: ``, image:`src="/images/rangiora_high_street_2023.png" alt="High Street in 2023 looking West from Victoria Street" height="90px" width="160px"`}
    ];
